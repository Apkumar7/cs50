#TODO: THIS IS THE FIRST VERSION OF THIS CODE, MORE VERSIONS ARE GOING TO BE COMING WITH COOLER AND COOLER FEATURES
#THIS CODE IS OFFICIALY WORKING PROPERLY, ALL FUNCTION RUN AS EXPECTED AND ARE STANDERD CALCULATOR ANSWERS!
...
#-----------------------------------------------------------------------------------------------------------------------------------------#
    if choice == "subtraction":
        #TODO: finish the subtraction code
...
#-----------------------------------------------------------------------------------------------------------------------------#
    ...
    print("This is not a valid operation, try multiplication, division, addition, subtraction, or square root")
